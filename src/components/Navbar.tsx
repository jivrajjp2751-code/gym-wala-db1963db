      ...
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        <Link to="/" className="flex items-center gap-3">
          <img
            ...
            className="h-12 w-12 rounded-full ring-1 ring-border bg-background"
            loading="eager"
            decoding="async"
          />
          <span className="font-display text-2xl tracking-wider text-primary">VJ'S SPORTS CLUB</span>
        </Link>
